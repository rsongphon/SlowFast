### Repository สร้างเพื่อแนะนำการติดตั้งและใช้งาน codebase PySlowFast จาก Facebook AI Reserch เนื่องจากทางต้นทาง ไม่ได้เขียนไว้ละเอียดพอและมีปัญหาในขั้นตอนการติดตั้ง สำหรับผู้ที่สนใจสามารถอ่านคำแนะนำการติดตั้งได้ใน INSTALL.md  และเนื่องจากปัญหาจุกจิกและบัคหลายจุดแนะนำให้ clone จาก repository นี้ไปติดตั้ง
